(function (collections, model) {
	...
	collections.Products = Backbone.Collection.extend({
		...
		initialize: function() {
			...
			this.page = 1;
			typeof(this.perPage) != 'undefined' || (this.perPage = 8);
		},
	  	...
	  	url: function() {
			//return '/marketplace.web/api/index.php/products' + '?' + $.param({page: this.page, perPage: this.perPage});
			
			return '/marketplace.web/api/data-products.json'
	  	},
...
})(MallRiot.collections, MallRiot.models.Product)